...
fit_unkGT <- sampling(ret_sm_unknownGT, warmup=100, iter=200, seed=123, data=full_data_unkGT, chains=4, control=list(adapt_delta=.85))
fit_unkGT

fit_unkGT_fixCoV <- sampling(ret_sm_unknownGT_fixCov, warmup=100, iter=200, seed=123, data=full_data_unkGT, chains=4, control=list(adapt_delta=.85))
fit_unkGT_fixCoV

fit_unkGT_fixCoV_noRoh <- sampling(ret_sm_unknownGT_fixCov, warmup=100, iter=200, seed=123, data=full_data_unkGT_noRoh, chains=4, control=list(adapt_delta=.85))
